            ...
            foreach( $perguntas as $value ){
                ...
                echo("<div class='container-fluid'>
                    <div class='card mt-3' style='background: #f5f4f2;border: 1px solid #333;'>
                        ...
                        <div class='card-footer text-muted'>
                        <button type='button' class='btn btn-warning' data-toggle='modal' data-target='#exampleModal$i' style='background-color: #FFCC66';>
                            Responder
                            </button>
                        </div>
                        </div>
                    ...
                    <div class='modal fade' id='exampleModal$i' tabindex='-1' aria-labelledby='exampleModalLabel' aria-hidden='true'>
                            <div class='modal-dialog'>
                                ...
                                <div class='modal-footer'>
                                    <button type='submit' class='btn btn-primary' name='vai' id='vai' value='$id' style='background-color: #FFCC66;'>Enviar</button>
                                    </form>
                                </div>
                                </div>
                            </div>
                    ...
                    if( $respostas ){
                        echo("<div class='card m-3' style='background: #f5f4f2;border: 1px solid #333;'>
                        <h5 class='card-header'>Respostas</h5>
                        <div class='card-body'>");
                        foreach( $respostas as $valor ){
                            $resposta = $valor['resposta'];
